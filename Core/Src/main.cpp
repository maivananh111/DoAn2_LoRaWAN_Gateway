...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOD, LORA_RST_Pin|LORA_CS_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LORA_IO0_Pin LORA_IO1_Pin */
  GPIO_InitStruct.Pin = LORA_IO0_Pin|LORA_IO1_Pin;
